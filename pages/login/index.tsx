					...
					<div className="flex flex-row">
						<div className="login-content">
							<form onSubmit={(e) => e.preventDefault()}>
								...
								<button
									className="w-100 py-2 px-3 flex justify-center items-center bg-gradient-to-tl from-blue-500 to-blue-300 rounded-full text-white focus:outline-none font-semibold shadow hover:transition-colors hover:bg-gradient-to-tr transform transition hover:scale-110 ease-out duration-300 hover:shadow-md"
									onClick={signInWithGoogle}
								>
