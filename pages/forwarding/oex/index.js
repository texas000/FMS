...
const Index = ({ Cookie }) => {
  ...
  async function getOex() {
    const oims = await fetch("/api/forwarding/oex/getList", {
      headers: {
  ...
  if (TOKEN && TOKEN.group) {
    return (
      <Layout TOKEN={TOKEN} TITLE="OCEAN EXPORT">
        <Dialog
          isOpen={isOpen}
...
//     return (
//       <span>
//         You do not have <span className="text-danger">Ocean Export</span> at the
//         moment
//       </span>
//     );
//   }
