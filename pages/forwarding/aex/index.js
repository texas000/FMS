...
const Index = ({ Cookie }) => {
  ...
  function indication() {
    return (
      <span>
        <span className="text-danger">No Air Export</span> at the moment
      </span>
    );
  }
  ...
  async function getAex() {
    const oims = await fetch("/api/forwarding/aex/getList", {
      headers: {
  ...
  if (TOKEN && TOKEN.group) {
    return (
      <Layout TOKEN={TOKEN} TITLE="AIR EXPORT">
        <Dialog
          isOpen={isOpen}
        ...
        <div className="d-flex flex-sm-row justify-content-between">
          <div className="flex-column">
            <h3 className="mb-4 forwarding font-weight-light">Air Export</h3>
          </div>
          <InputGroup
            leftIcon="search"
            type="number"
...
//             `/forwarding/aex/${row.aommain.RefNo}`
//           );
//         },
//       },
//       classes:
...
//                     router.push(
//                       `/forwarding/aex/[Detail]`,
//                       `/forwarding/aex/${ga.aommain.RefNo}`
//                     );
//                   }}
//                   className="list-group-item list-group-item-action text-xs text-truncate"
//                 >
...
//                   <i className="fa fa-arrow-right text-success mx-2"></i>
//                   <span className="font-weight-light">
//                     {ga.aohmain.Customer_SName}
//                   </span>
//                   <i className="fa fa-arrow-right text-warning mx-2"></i>
//                   <span className="text-uppercase">{ga.aommain.U2ID}</span>
//                 </a>
//               ))
//             ) : (
//               <div
...
//       `${process.env.FS_BASEPATH}aommain_leftjoin_aohmain?PIC=${fsid}&etaFrom=&etaTo=&etdFrom=&etdTo=&casestatus=`,
//       {
