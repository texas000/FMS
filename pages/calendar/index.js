        ...
        <Layout TOKEN={TOKEN} TITLE="Calendar">
          ...
          <Modal isOpen={addModal} toggle={addToggle}>
            <ModalHeader toggle={addToggle}>
              {addModalInfo.length && addModalInfo[0].title}
            </ModalHeader>
            <ModalBody>
              <p>
                START:{" "}
                {addModalInfo.length &&
                  moment(addModalInfo[0].start).format("LLL")}
              </p>
              <p>
                END:{" "}
                {addModalInfo.length &&
                  moment(addModalInfo[0].end).format("LLL")}
              </p>
...
export async function getServerSideProps({ req }) {
  ...
  console.log(
    jwt.decode(cookies.jamesworldwidetoken).username + " loaded calendar"
  );
