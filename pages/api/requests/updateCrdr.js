...
export default async (req, res) => {
  ...
  var query = `UPDATE T_REQUEST_CRDR SET STATUS='${status}', UPDATEDBY='${token.uid}', UPDATED=GETDATE() WHERE ID='${id}';
    SELECT TOP 1 *, (SELECT F_EMAIL FROM T_MEMBER M WHERE M.F_ID=T_REQUEST_CRDR.CREATEDBY) AS CREATOR FROM T_REQUEST_CRDR WHERE ID='${id}';`;
                    ...
                    <tr>
                      ...
                      >
                        ...
                        <tr style="line-height: 0">
                          ...
                          <td style="line-height: 22px">${result.recordset[0].AGENT}</td>
                        </tr>
                        <tr style="line-height: 0">
                          <td width="200">
                            <ul style="list-style-type: circle">
