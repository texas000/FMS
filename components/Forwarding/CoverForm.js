...
export const CoverForm = ({
  ...
  loading &&
    discharge &&
    Info.push({ dummy: "ROUTE", data: `${loading} ~ ${discharge}` });
  ...
  container &&
    ...
    container.map((ga, i) => {
      Info.push({
        dummy: `CTNR ${i + 1}`,
        data: `${ga.F_ConType} / ${ga.F_ContainerNo} / ${ga.F_SealNo}`,
      });
    });
  ...
  return (
    <Document>
      <Page size="LETTER" style={styles.body}>
        ...
        >
          ...
          >
            <TableHeader>
              ...
              <TableCell
                style={{ textAlign: "left", fontSize: 9, paddingLeft: "4px" }}
              >
                {""}
              </TableCell>
            </TableHeader>
        ...
        >
          <Table data={type === "air" ? air_list : ocean_list}>
            <TableHeader>
              <TableCell
                style={{
                  textAlign: "center",
