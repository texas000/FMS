                ...
                {/* <BlobProvider
                  document={
                    <CoverForm
                      ...
                      vessel={`${
                        Master.F_Vessel || Master.F_FLTno || Master.F_FLTNo
                      }`}
                  ...
                  {({ url }) => (
                    <a href={url} target="_blank">
                      <Button
                        ...
                        disabled={!isClient}
                      >
                        <i className="fa fa-print mr-2"></i>COVER
                      </Button>
                    </a>
                  )}
                </BlobProvider>
            ...
            AP.map((ga) => (
              ...
              >
                {({ url }) => (
                  <a href={url} target="_blank">
                    <Badge
                      className="mt-2 mr-2 text-white text-wrap"
