...
export const Activity = ({ REF, USER, EXTRA }) => {
	...
	const [CM3, setCM3] = useState(false);
	const [CM4, setCM4] = useState(false);
	const [CM5, setCM5] = useState(false);
	const [CM6, setCM6] = useState(false);
	const [CM7, setCM7] = useState(false);
