	...
	return (
		<div className="w-full xl:w-1/2 card p-3 mb-4">
				...
				<div className="w-full px-8 absolute top-8">
					<div className="flex justify-between">
						<div className="">
							...
							<p className="font-medium tracking-widest">James Worldwide Inc</p>
						</div>
			...
			<button
				...
				className="my-2 p-2 rounded font-semibold bg-purple-600 text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50"
			>
				Checkout
			</button>
		</div>
